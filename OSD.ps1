...
start /wait PowerShell -NoL -C Start-AutopilotOOBE -Title 'CreashRebootRepeat Registration' -GroupTag Enterprise -GroupTagOptions Development,Enterprise -Assign
'@
