...
Function Get-WindowsAutoPilotInfo {
    ...
    param(
        ...
        [Parameter(Mandatory=$False,ParameterSetName = 'Online')] [String] $TenantId = "57a4b287-a8d2-452b-acfd-242d26c3630c",
        [Parameter(Mandatory=$False,ParameterSetName = 'Online')] [String] $AppId = "235d10fe-187e-40a3-9230-10f190ea4f58",
        [Parameter(Mandatory=$False,ParameterSetName = 'Online')] [String] $AppSecret = "wVW8Q~MoiE1EAwZY2ltU4dh-P~I0AXv8RCPdAbcO",
        ...
        [Parameter(Mandatory=$False,ParameterSetName = 'Online')] [Switch] $Reboot = $true
    )
